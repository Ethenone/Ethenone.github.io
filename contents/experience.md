...
- Reproduced and evaluated multiple existing cell segmentation and abnormal cell recognition systems.

- Integrated several recognition models using a multilayer perceptron (MLP) to achieve higher classification accuracy.

- Developed an end-to-end system using cascading cell segmentation and recognition modules for immunohistochemically stained pathological images.
...
- Screened lung cell-Specific DNA methylation sites by wgbstools.

- Conducted gene annotation, functional analysis, cell type clustering analysis, and result visualization on identified cell-specific sites.
